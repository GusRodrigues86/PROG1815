...
namespace BookManagementAssignment2Tests
{
    public class Tests
    {
        ...
        #endregion
        #region Whitespeace leading input
        [Test]
        ...
        #endregion
        #region Email Validation test cases
        [Test]
        ...
        #endregion
        #region Test cases for date
        [Test]
        [SetCulture("en-CA")]
        public void DateInTheFuture_ReturnsFalse()
        {
            DateTime tomorrow = DateTime.Today.AddDays(1);
            Assert.IsFalse(GBRDateValidation(tomorrow.ToString("dd MMM yyyy")));
        }
        [Test]
        [SetCulture("en-CA")]
        public void DateInThePast_ReturnsTrue()
        {
            DateTime pastDate = new DateTime(1969, 07, 20);
            Assert.IsTrue(GBRDateValidation(pastDate.ToString("dd MMM yyyy")));
        }
        [Test]
        [SetCulture("en-CA")]
        public void TodayIsValid_ReturnsTrue()
        {
            DateTime today = DateTime.Today;
            Assert.IsTrue(GBRDateValidation(today.ToString("dd MMM yyyy")));
        }
        #endregion
    }
}